...
class Results(Page):
    ...
    def before_next_page(self):
        self.player.participant.vars['total_payoff_plur_pob1']=sum([p.payoff for p in self.player.in_all_rounds()])
        self.player.participant.vars['rol_plur_pob1']=self.player.role
