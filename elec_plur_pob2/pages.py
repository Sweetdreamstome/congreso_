...
class Final(Page):
    ...
    def before_next_page(self):
        self.player.participant.vars['total_payoff_plur_pob2']=sum([p.payoff for p in self.player.in_all_rounds()])
        self.player.participant.vars['rol_plur_pob2']=self.player.role
