...
class Constants(BaseConstants):
    ...
    contact_template = "measure_task/Contactenos.html"
...
class Player(BasePlayer):
    ...
    first_choice_1 = models.IntegerField(verbose_name='Escojo la lotería A desde la opción 1 hasta la opción:', label='Escojo la lotería A desde la opción 1 hasta la opción:', choices=Constants.choices_series1)
    first_choice_2 = models.IntegerField(verbose_name='Escojo la lotería A desde la opción 15 hasta la opción:', label='Escojo la lotería A desde la opción 15 hasta la opción:', choices=Constants.choices_series2)
    first_choice_3 = models.IntegerField(verbose_name='Escojo la lotería A desde la opción 29 hasta la opción:', label='Escojo la lotería A desde la opción 29 hasta la opción:', choices=Constants.choices_series3)
    second_choice_1 = models.IntegerField(verbose_name='Escojo la lotería B desde la opción:', label='Escojo la lotería B desde la opción:', choices=Constants.choices_series1)
    second_choice_2 = models.IntegerField(verbose_name='Escojo la lotería B desde la opción:', label='Escojo la lotería B desde la opción:', choices=Constants.choices_series2)
    second_choice_3 = models.IntegerField(verbose_name='Escojo la lotería B desde la opción:', label='Escojo la lotería B desde la opción:', choices=Constants.choices_series3)
    ...
    def set_payoffs(self):
        ...
        # Otorgar el endowment de 30 si le salió un payoff negativo porque pagó un costo:
        if (self.payoff < 0):
            self.payoff = self.payoff + 30
