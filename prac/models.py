...
class Constants(BaseConstants):
    ...
    instructions_template_voter = 'prac/instructions_voter.html'
    instructions_template_politician = 'prac/instructions_politician.html'
    contact_template = "prac/Contactenos.html"
    mapa_eleccion = "prac/Mapita_eleccion.html"
    mapa_gestion = "prac/Mapita_gestion.html"
    desplegable = "prac/Desplegable.html"
  ...
  #  def reasignar_roles(group):
    ...
    def multiplicar_votos(group):
        ...
        for jugadorcito in jugadorcitos:
            if jugadorcito.runoff == False:
                group.habra_segunda = False
                #1. MULTIPLICA VOTOS
                #Registrar el voto del votante tipo 1
                if group.voto1 == 1:
                    group.votos_a = jugadorcito.voter1multip
                else:
                    group.votos_a = 0
                if group.voto1 == 2:
                    group.votos_b = jugadorcito.voter1multip
                else:
                    group.votos_b = 0
                if group.voto1 == 3:
                    group.votos_c = jugadorcito.voter1multip
                else:
                    group.votos_c = 0
                #Registrar el voto del votante tipo 2
                if group.voto2 == 1:
                    group.votos_a = group.votos_a + jugadorcito.voter2multip
                else:
                    group.votos_a = group.votos_a
                if group.voto2 == 2:
                    group.votos_b = group.votos_b + jugadorcito.voter2multip
                else:
                    group.votos_b = group.votos_b
                if group.voto2 == 3:
                    group.votos_c = group.votos_c + jugadorcito.voter2multip
                else:
                    group.votos_c = group.votos_c
                #Registrar el voto del votante tipo 3
                if group.voto3 == 1:
                    group.votos_a = group.votos_a + jugadorcito.voter3multip
                else:
                    group.votos_a = group.votos_a
                if group.voto3 == 2:
                    group.votos_b = group.votos_b + jugadorcito.voter3multip
                else:
                    group.votos_b = group.votos_b
                if group.voto3 == 3:
                    group.votos_c = group.votos_c + jugadorcito.voter3multip
                else:
                    group.votos_c = group.votos_c
            ...
            #ESTO ES PARA EL CONGRESO:
                if jugadorcito.congresal == True:
                    ...
                    if group.voto1_cong == 1:
                        group.votos_a_cong = jugadorcito.voter1multip
                    else:
                        group.votos_a_cong = 0
                    if group.voto1_cong == 2:
                        group.votos_b_cong = jugadorcito.voter1multip
                    else:
                        group.votos_b_cong = 0
                    if group.voto1_cong == 3:
                        group.votos_c_cong = jugadorcito.voter1multip
                    else:
                        group.votos_c_cong = 0
                    #Registrar el voto del votante tipo 2
                    if group.voto2_cong == 1:
                        group.votos_a_cong = group.votos_a_cong + jugadorcito.voter2multip
                    else:
                        group.votos_a_cong = group.votos_a_cong
                    if group.voto2_cong == 2:
                        group.votos_b_cong = group.votos_b_cong + jugadorcito.voter2multip
                    else:
                        group.votos_b_cong = group.votos_b_cong
                    if group.voto2_cong == 3:
                        group.votos_c_cong = group.votos_c_cong + jugadorcito.voter2multip
                    else:
                        group.votos_c_cong = group.votos_c_cong
                    #Registrar el voto del votante tipo 3
                    if group.voto3_cong == 1:
                        group.votos_a_cong = group.votos_a_cong + jugadorcito.voter3multip
                    else:
                        group.votos_a_cong = group.votos_a_cong
                    if group.voto3_cong == 2:
                        group.votos_b_cong = group.votos_b_cong + jugadorcito.voter3multip
                    else:
                        group.votos_b_cong = group.votos_b_cong
                    if group.voto3_cong == 3:
                        group.votos_c_cong = group.votos_c_cong + jugadorcito.voter3multip
                    else:
                        group.votos_c_cong = group.votos_c_cong
        ...
        if group.habra_segunda == True:
            ...
            for jugador in jugadores:
                ...
                if group.voto1_2da == 1:
                    group.votos_1ro_1ra = jugador.voter1multip
                else:
                    group.votos_1ro_1ra = 0
                if group.voto1_2da == 2:
                    group.votos_2do_1ra = jugador.voter1multip
                else:
                    group.votos_2do_1ra = 0
                #Registrar el voto del votante tipo 2
                if group.voto2_2da == 1:
                    group.votos_1ro_1ra = group.votos_1ro_1ra + jugador.voter2multip
                else:
                    group.votos_1ro_1ra = group.votos_1ro_1ra
                if group.voto2_2da == 2:
                    group.votos_2do_1ra = group.votos_2do_1ra + jugador.voter2multip
                else:
                    group.votos_2do_1ra = group.votos_2do_1ra
                #Registrar el voto del votante tipo 3
                if group.voto3_2da == 1:
                    group.votos_1ro_1ra = group.votos_1ro_1ra + jugador.voter3multip
                else:
                    group.votos_1ro_1ra = group.votos_1ro_1ra
                if group.voto3_2da == 2:
                    group.votos_2do_1ra = group.votos_2do_1ra + jugador.voter3multip
                else:
                    group.votos_2do_1ra = group.votos_2do_1ra
